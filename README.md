...
Before run IReNA, you need to prepare 6 files, where bam file, Peak
file, footprints file can be generated by [ATAC-seq analysis
...
Bam of IReNA input should be the consequence of step11 in [ATAC-seq
