...
motif_select <- function(motif,gene){
  index <- c()
...
#' @param gtf data.frame, indicating gtf file of all peaks, generated by \item{generate_gtf} function
#'
...
#' Merge the peaks that are close to each other and modify the length of the peak to 500. Finally, return peaks related gtf file
#'
