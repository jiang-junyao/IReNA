...
#' @description combine all footprints related motifs which generated by fimo. Before run this function you should check whether the 'Dir' only contain consequence of fimo
...
#' @description Because the running time of this function is too long, it's highly recommanded to use bedtools to implement this function
...
#' Find motifs
#' @description Generate shell commands to find motifs in the footprints through fimo software.
