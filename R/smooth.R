...
#' @description this function is used to filter the bins in the expression
#' profile which value is zero
...
fileter_expression_profile <- function(expression_profile, filterfc = TRUE,
                                       FC = 0.1) {
