...
#' this function is used to filter the bins in the expression profile which value is zero
#'
#' @param expression_profile expression profile
#' @param filterfc whether you want to filter genes based on logFC
#' @param FC logFC threshold
#'
...
#' Display the result of clustering based on pheatmap, the first column should be KmeansGroup, from the third column to the last column should be expression value
#'
...
#' @param show_colnames TRUE or FALSE, whether show column names, default is FALSE
...
#' @param legend1 TRUE or FALSE, whether show the legend, default is TRUE
#' @param border_color color of cell borders on heatmap, use NA if no border should be drawn.
#' @param ByPanel TRUE or FALSE, if TRUE, reorder columns of heatmap according to the parameter ColumnGroup1, default is FALSE
#' @param Color1 colors used in heat map
#' @param Show.Module TRUE or FALSE, whether show the module, defalut is TURE
#' @param ColumnGroup1 vector, if it is not NULL, this function wil sepate columns according to varible ColumnGroup1, default is NULL
...
#' @return figure
#' @examples
#' plot_kmeans_pheatmap(Kmeans_clustering, Range1=c(-2,2))
#'
