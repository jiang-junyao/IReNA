...
#' @description Calculate the FOS(footprints occupancy score) to identify enriched transcriptions factor, and use these transcription factors to identify significant regulatory relationships
#' @param Wig_list list object, where each element is the \link{wig_track} result of each sample.
