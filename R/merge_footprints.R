...
#' @param ditance numeric, indicating the cutoff for merging footprints
...
#'
#' @examples
get_merged_fasta<-function(footprints, ditance = 4, fastadir){
  merged_footprints<-merge_footprints(footprints,distance=distance)
