...
The goal of IReNA is to reconstruct regulatory networks through integrating scRNA-seq and ATAC-seq data.

## Citation
if you use this package please cite the following published paper: https://science.sciencemag.org/content/370/6519/eabb8598
...
We stored the Tranfac201803 database for 4 species(Homo sapiens, Mus musculus, Zebrafish and Chicken) in this package. You can use following codes to call these databases, or you can use your own motif database which should have the same format as our stored motif database.
```r
