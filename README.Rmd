...
```
In this step, we count the cuts of each position in footrprints by wig_track(), and use hese cuts to calculate the FOS of footprints to identify enriched TFs which determine the regulatory relationship.
```r
